...
namespace ProjectServiceEZATU.DTO.Response.generate
{
    ...
    public class GenPDFResumeResponse
    {

        internal int status;
        internal string message;
        public FileStreamResult ResultPdf ;
        public GenPDFResumeDataResponse data { get; set; }

    }

    public class ScreenInfoGenPDFResumeResponse
    {
        public string aboutme { get; set; }
    ...
    public class GenPDFResumeDataResponse
    {

        public bool resumeColor { get; set; }
        public UserInfoGenPDFResumeResponse userinfo { get; set; }
        public List<PositionGenPDFResumeResponseList> position { get; set; }
        public string aboutme { get; set; }
        public PersonInfoGenPDFResumeResponse contactinfo { get; set; }
        public AddressViewsResumeResponse address { get; set; }
        public List<ExperienceGenPDFResumeResponse> experience { get; set; }
        public EducationResumeResponseLists education { get; set; }
        public List<SkillGenPDFResumeResponse> skill { get; set; }
        public List<CertificateViewsResumeResponse> certificate { get; set; }
        public List<LanguageViewsResumeResponse> language { get; set; }
        public ResumeDataCounts resumedatacount { get; set; }
        public ResumeDataColors resumedatacolor { get; set; }
        public EducationbdGenPDFResumepreview educationbd { get; set; }
        public EducationmdGenPDFResumepreview educationmd { get; set; }
        public EducationddGenPDFResumepreview educationdd { get; set; }
        public EducationhddGenPDFResumepreview educationhdd { get; set; }
        public PositionGenPDFResumeResponse positiongenpdf { get; set; }
        public PositionGenPDFResumeResponse2 positiongenpdf2 { get; set; }
        public PositionGenPDFResumeResponse3 positiongenpdf3 { get; set; }
        public ExperienceGenPDFResumeResponses experiencegenpdf { get; set; }
        public ExperienceGenPDFResumeResponseOrder2 experiencegenpdf2 { get; set; }
        public ExperienceGenPDFResumeResponseOrder3 experiencegenpdf3 { get; set; }
        public EducationhscGenPDFResumepreview educationhsc { get; set; }
        public SkillGenPDFResumeResponses skillGenPDFResumeResponses { get; set; }
        public CertificateViewsResumeResponses certificateViewsResume { get; set; }
        public LanguageViewsResumeResponses languageViewsResume { get; set; }
        public LanguageViewsResumeResponses2 languageViewsResume2 { get; set; }
        public LanguageViewsResumeResponses3 languageViewsResume3 { get; set; }
        public SkillGenPDFResumeResponseOrder2 skillOrder2 { get; set; }
        public SkillGenPDFResumeResponseOrder3 skillOrder3 { get; set; }
        public pdfscreen Pdfscreen { get; set; }
        public string image { get; set; }
    }
    ...
    public class EducationbdGenPDFResumepreview
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
    ...
    public class EducationmdGenPDFResumepreview
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public string userlanguage { get; set; }
    ...
    public class EducationddGenPDFResumepreview
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public string userlanguage { get; set; }
    ...
    public class EducationhddGenPDFResumepreview
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public string userlanguage { get; set; }
    ...
    public class EducationhscGenPDFResumepreview
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public string userlanguage { get; set; }
    ...
    public class PositionGenPDFResumeResponseList
    {
    ...
    public class PositionGenPDFResumeResponse
    {
    ...
    public class PositionGenPDFResumeResponse2
    {
    ...
    public class PositionGenPDFResumeResponse3
    {
    ...
    public class UserInfoGenPDFResumeResponse
    {
    ...
    public class PersonInfoGenPDFResumeResponse
    {
        public string email { get; set; }
        public string phone { get; set; }
        public string facebook { get; set; }
    ...
    public class ExperienceGenPDFResumeResponse
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class ExperienceGenPDFResumeResponses
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class ExperienceGenPDFResumeResponseOrder2
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class ExperienceGenPDFResumeResponseOrder3
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class EducationResumeResponseLists
    {
        public List<EducationGenPDFResumeResponseHSC> hsc { get; set; }
        public List<EducationGenPDFResumeResponse> bd { get; set; }
        public List<EducationGenPDFResumeResponse> md { get; set; }
        public List<EducationGenPDFResumeResponse> dd { get; set; }
        public List<EducationGenPDFResumeResponse> hdd { get; set; }
    }
    public class EducationGenPDFResumeResponseHSC
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class EducationGenPDFResumeResponse
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class SkillGenPDFResumeResponse
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class SkillGenPDFResumeResponses
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class SkillGenPDFResumeResponseOrder2
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class SkillGenPDFResumeResponseOrder3
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class CertificateViewsResumeResponse
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class CertificateViewsResumeResponses
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class LanguageViewsResumeResponse
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class LanguageViewsResumeResponses
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class LanguageViewsResumeResponses2
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class LanguageViewsResumeResponses3
    {
        public int id { get; set; }
        public int orderchoose { get; set; }
        public bool onselect { get; set; }
    ...
    public class AddressViewsResumeResponse
    {
